...
$phone = get_field('info_phone', 'option');
$info_portsmouth_address = get_field('info_portsmouth_address', 'option');
$info_portsmouth_phone = get_field('info_portsmouth_phone', 'option');
$info_concord_address = get_field('info_concord_address', 'option');
$info_concord_phone = get_field('info_concord_phone', 'option');
$info_footer_bg_image = get_field('info_footer_bg_image', 'option');
?>

<footer id="site-footer" style="background-image: url('<?php echo esc_url($info_footer_bg_image['url']); ?>')" class="relative overflow-hidden  no-repeat bg-cover">
