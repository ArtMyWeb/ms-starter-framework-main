<?php
// block_10_reviews
if ( get_row_layout() !== 'block_10_reviews' ) { return; }
  ...
  <div class="o-container">
    <div class="o-row">
      <div class="o-col--xxs-12 o-col--md-4">
        <?php if ( $block_10_title ): ?><h2><?php echo $block_10_title; ?></h2><?php endif; ?>
      </div>
      <div class="o-col--xxs-12 o-col--md-8">
        <?php if ( $block_10_subtitle ): ?><p class="c-lead u-text--accent-1"><?php echo $block_10_subtitle; ?></p><?php endif; ?>
        <?php if ( $block_10_content ): ?><?php echo $block_10_content; ?><?php endif; ?>
      </div>
    </div>
    <div class="o-row">
          ...
          <div class="c-reviews__list">
            ...
            <div class="c-reviews__item u-text--center">
              <blockquote class="c-reviews__quote u-reset--blockquote">
                <?php if ( $block_10_quote ): ?><?php echo $block_10_quote; ?><?php endif; ?>
                <?php if ( $block_10_author ): ?><cite class="c-reviews__author"><?php echo $block_10_author; ?></cite><?php endif; ?>
              </blockquote>
            </div>
            <?php endwhile; ?>
          </div>
