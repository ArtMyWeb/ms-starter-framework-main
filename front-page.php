...
<section class="padding-admin relative min-h-screen">
    ...
    <div class="container relative  pb-0">
        <div class="home-hero hero-block">
            <h1
                class="home-hero-title text-white text-center justify-center flex flex-col font-archivo text-[120px] font-extrabold leading-[109px] uppercase">
            ...
            <div
                class="person-content flex flex-col items-center text-center gap-10 relative pt-[400px] max-w-[770px] z-2 mx-auto p-10 -mt-[120px]">
                <img class="person-img max-w-[500px] absolute bottom-0 left-1/2 -translate-x-1/2 object-contain "
                    src="/wp-content/uploads/2025/11/headshot-1.png" alt="">
...
<section class="text-media-section bg-dark">
    <div class="container">
        <div class="grid grid-cols-1 lg:grid-cols-[623px_1fr] gap-[100px] text-white flex-1">
            <div class="relative ">
                <img class="w-full h-full object-cover max-h-[750px]" src="/wp-content/uploads/2025/11/DSC_7426-1.png"
                    alt="">
            </div>
            <div>
                <div class="vertical-border mb-5">
                    <h2 class="text-white flex flex-col ">Representing <span class="text-light-gold">Vulnerable
                            Clients</span></h2>
                    <h4 class="subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                ...
                <div class="text-about mb-11">
                    <p>Our founding attorney, Leif Becker, prioritizes putting his clients in the best possible position
                        for resolving their legal disputes. He has accepted more than 70 pro bono cases since 2019
                        including many from New Hampshire’s Domestic Violence Emergency Project (DOVE). He stepped up in
                        the wake of the COVID-19 pandemic to ensure vulnerable clients in distress due to domestic
                        violence received the legal services and protection they needed in their time of crisis. Serving
                        clients throughout the state, attorney Becker received recognition from The New Hampshire Bar
                        Association (NHBA) for his commitment to equal justice for disadvantaged and low-income clients;
                        he was named as a 2021 Pro Bono Rising Star for his valuable contributions. </p>
                    <p>Attorney Becker was named a 2020 recipient of “Life Changer” award by Haven, the state’s
                        preeminent domestic violence and sexual violence support and prevention agency. The agency
                        serves 48 communities in southeastern New Hampshire.</p>
                </div>
    ...
    <div class="container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div class="vertical-border bg-light-dark  p-5 text-white">
                ...
                <p class="text-[0.9rem] leading-relaxed opacity-90">Lorem ipsum dolor sit amet, consectetur adipiscing
                    elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            </div>
            <!-- Card 2 -->
            <div class=" bg-light-dark  p-5 text-white">
                <h3 class="text-[1.25rem] font-semibold mb-4 leading-tight">Seacoast 10 To Watch – 2022 (Seacoast
                    Online)</h3>
                <p class="text-[0.9rem] leading-relaxed opacity-90">Lorem ipsum dolor sit amet, consectetur adipiscing
                    elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            </div>
            ...
            <!-- Card 4 -->
            <div class=" bg-light-dark p-5 text-white">
                <h3 class="text-[1.25rem] font-semibold mb-4 leading-tight">Pro Bono Rising Star Award, New Hampshire
                    Bar Association, 2021</h3>
                <p class="text-[0.9rem] leading-relaxed opacity-90">Lorem ipsum dolor sit amet, consectetur adipiscing
                    elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            </div>
        </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    ?>
                        <div class="swiper-slide flex items-center">
                            <div
                                class="slide-content  text-white flex flex-col items-center gap-5 text-center justify-center">
                                ...
                                <div class="slide-about">
                                    ...
                                    <p class="text-[1.75rem]/[1.3]">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="practice-areas pb-[70px]">
            <div class="vertical-border flex  gap-5 justify-between">
                <div class="text-side max-w-[50%] flex flex-col gap-5">
                    ...
                    <p>Lorem ipsum dolor sit amet consecur adipiscing elit quisque faucibus exLorem ipsum dolor sit amet
                        consecur adipiscing elit quisque fa</p>
                </div>
            ...
            ?>
                <article class="blog-item group    h-full  overflow-hidden ">
                    <div class="relative ">
                        ...
                        <div
                            class="blog-content flex flex-col  text-white z-10  vertical-border bg-light-dark/90 p-5 !absolute bottom-0 left-0 w-full">
                            <h3 class="text-[1.375rem]/[1.2] font-archivo font-semibold pb-2">Family Law</h3>
                            <div class="blog-excerpt">
                                <div class="colapseble ">
                                    <div class="overflow-hidden">
                                        <p>Lorem ipsum dolor sit amet consecur adipiscing elit quisque faucibus exLorem
                                            ipsum dolor sit amet consecur adipiscing elit quisque fa</p>
                                    </div>
                                </div>
                            </div>
                            <a href="#"
                                class="text-light-gold text-[1rem]/[1.2] font-archivo font-medium underline underline-offset-5 ">Read
                                More</a>
                        </div>
                    </div>
                </article>
            ...
            ?>
                <article class="video-item">
                    <a href="#" class="flex flex-col">
                        ...
                        <div
                            class="blog-content flex flex-col  text-white z-10  vertical-border bg-light-dark/90 p-5  bottom-0 left-0 w-full">
                            <h3 class="text-[1.375rem]/[1.2] font-archivo font-semibold pb-2">Family Law</h3>
                            <div class="blog-excerpt">
                                <div class="">
                                    <div class="overflow-hidden">
...
<section class="meet-your-attorneys bg-[#0D0D0D]">
    <div class=" container-sm ">
        ...
        <div class="attorneys-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-20">
            ...
            ?>
                <article
                    class="attorneys-item overflow-hidden flex     flex-col justify-end aspect-[25/34] !pl-0  vertical-border bg-[url(/wp-content/uploads/2025/11/Frame-1171276039.svg)] bg-no-repeat  bg-[#2A2A2B]  ">
                    <div
                        class="overlay-block absolute z-[5] inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.21)_50%,rgba(0,0,0,0.82)_100%)] ">
                    </div>
                    ...
                    <div
                        class="content-block flex flex-col gap-2 justify-center items-center absolute z-10 w-full  bottom-10 max-w-[320px] mx-auto left-1/2 -translate-x-1/2">
    ...
    <div class="container-sm relative z-10">
        <div class="content-cta">
            <div class="flex  flex-col items-center gap-8 text-center">
                ...
                <span class="!text-[1.7rem]/[1.2] font-archivo ">Schedule a Free Consultation | Call 24/7 <a
                        class="!text-[1.7rem]/[1.2] font-archivo  !no-underline" href="tel:0000000000">(603)
                        802-8100</a> </span>
                <h2 class="flex items-center flex-col text-[72px]/[1] font-bold uppercase"> <span class="">Strength and
                        Strategy </span><span class="text-transparent bg-clip-text bg-gradient-gold">for Every
                        Battle.</span></h2>
                <p>From administrative hearings to district and superior courts of NH and Maine, NH Supreme Court, 1st
                    Circuit for the District of New Hampshire and the 1st Circuit Court of Appeals we have practiced at
                    all levels from child custody cases to homicide to precedential NH Supreme Court case law. </p>
            ...
            ?>
                <div class="accordion-item vertical-border p-6  mb-6 bg-light-dark">
                    <div class="accordion-header">
                        <p class="!text-[1.25rem]/[1.2] text-light-gold">Duis aute irure dolor in reprehenderit in voluptate
                    ...
                    <div class="accordion-content-container">
                        <div class="accordion-content  text-white ">
                            <p>Lorem ipsum dolor sit amet consectetur adipiscing elit quisque faucibus ex sapien vitae
                                ...
                                penatibus et magnis dis parturient montes nascetur ridiculus mus donec rhoncus eros lobortis
                                nulla molestie mattis scelerisque maximus eget fermentum odio phasellus non purus est
                                efficitur laoreet mauris pharetra vestibulum fusce dictum risus.</p>
                        </div>
                    </div>
                </div>
            <?php
    ...
    <div class="container">
        ...
        <div class="grid-block grid grid-cols-1 lg:grid-cols-2 gap-[60px]">
            <div class="grid-item">
                ...
                <p>Donec ut nulla non sapien tristique pretium. Nam ut sollicitudin lorem. Suspendisse eget libero sit
                    amet orci iaculis tincidunt. Sed dignissim lacinia mauris, et condimentum ante bibendum a. Sed a
                    dapibus est. Mauris a rutrum orci. Sed ut iaculis nulla. Nullam vel imperdiet leo. Quisque consequat
                    augue ut congue suscipit. Mauris lobortis urna ut volutpat tincidunt.
                    Fusce quis turpis tellus. Integer fringilla ipsum nec nulla tincidunt, at malesuada purus rhoncus.
                    Nunc vulputate, augue non tincidunt gravida, ante tortor fermentum enim, eget volutpat justo mi at
                    elit. In a erat ut lorem imperdiet bibendum. Sed consequat enim ac diam accumsan, vel laoreet metus
                    cursus. Cras a neque libero. Aenean non nibh bibendum, dictum risus in, convallis magna.</p>
            </div>
            <div class="grid-item">
                <h3>Curabitur Accumsan Sem Vel</h3>
                <p>Donec ut nulla non sapien tristique pretium. Nam ut sollicitudin lorem. Suspendisse eget libero sit
